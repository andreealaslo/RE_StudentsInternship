...
interface Application {
    ...
    internship: {
        id: number;
        title: string;
        remainingSlots: number; // Added this field
    };
                ...
                setApplications((prevApplications) =>
                    prevApplications.map((application) => {
                        if (application.id === applicationId) {
                            ...
                            // Decrease remainingSlots if status is ACCEPTED
                            if (status === "ACCEPTED") {
                                updatedApplication.internship.remainingSlots =
                                    application.internship.remainingSlots > 0
                                        ? application.internship.remainingSlots - 1
                                        : 0;
                            }
                                    ...
                                    >
                                        <CardContent>
                                            ...
                                            <Box sx={{ marginTop: 1 }}>
                                                ...
                                                <Typography variant="body1">
                                                    <strong>Remaining Slots:</strong> {application.internship.remainingSlots}
                                                </Typography>
                                                <Typography variant="body1">
